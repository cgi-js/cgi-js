...
let proc = obj.process.fork(path.join(__dirname, "test.cgi.process.exec.js"), [], {
    ...
    console.log("Starting Tests for test.cgi.process.fork dataHandlers tests")
    ...
    console.log("Ending Tests for test.cgi.process.fork dataHandlers tests")
})

proc.on("close", (exitcode, anydata) => {
    console.log("Starting Tests for test.cgi.process.fork close handlers tests")
    ...
    console.log("Ending Tests: with above failure test.cgi.process.fork close handlers tests")
})
