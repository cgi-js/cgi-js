...
* [] Python development server using `http.server` [PLANNED] <!-- If Python version returned above is 3.X. # On Windows, try "python -m http.server" or "py -3 -m http.server". If Python version returned above is 2.X use SimpleHTTPServer. python3 -m http.server OR python -m SimpleHTTPServer -->
